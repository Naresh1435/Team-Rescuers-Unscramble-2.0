...
const Navigation = () => {
  ...
  return (
    <SafeAreaView>
        ...
        <View style={tw` border-b border-white mb-2`}></View>
            <View style={tw`flex flex-row mx-5 justify-around`}>
                <TouchableOpacity  style={tw` flex flex-col items-center`} onPress={()=>navigator.navigate('Explore')} >
                    <Icon name="explore"  color="#FFF" size={28}/>
                    <Text style={{color:"#fff", marginTop:5, fontWeight:700}}>Explore</Text>
                </TouchableOpacity>
                <TouchableOpacity  style={tw` flex flex-col items-center`} onPress={()=>navigator.navigate('Booking')}>
                    ...
                    <Text style={{color:"#FFF", marginTop:5, fontWeight:700}}>Tasks</Text>
                </TouchableOpacity>
                ...
                <TouchableOpacity  style={tw` flex flex-col items-center`} onPress={()=>navigator.navigate('SignOut')}>
